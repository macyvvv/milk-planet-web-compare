...
const events = [
    ...
    //['eventDay','eventName','eventImgName(jpg)']
       ['▶︎▶︎▶︎','&emsp;<a href= "http://milk-planet.com/recruit/" >きゃすと・げすとさん大募集！♡</a>','event0']
      ],
    ...
    for(i=0; i<events.length;i++){
          ...
          for(j=0;j<events[i].length;j++){
              eventimage = eventimage +
                ...
                '.jpg" class="gallery" data-group="gallery"><img src="http://milk-planet.com/event/'+events[i][j][2]+'.jpg"></a></li>';
          }

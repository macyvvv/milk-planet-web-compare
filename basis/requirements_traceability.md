...
| TR-09 | 正本・比較元・改修対象を混同しない | `basis/README.md`、`basis/system_spec.md` | `DESIGN.md`、branch5の`menu/index.html`（改修）、`menu/index_0.html`（保存原典）、`menu-html/`（比較実装）を分離 | repo contract、work packet | scope audit | ACTIVE |
